...
- [Полезные советы](https://github.com/pepe-i-shim/thinkpad-from-ebay/blob/master/README.md#Полезные-советы)
...
- Если покупаешь через посредника – в 90% случаев оплачиваешь доставку по США от продавца до посредника (10-15$). Как этого можно попробовать избежать описано в [Полезных советах](https://github.com/pepe-i-shim/thinkpad-from-ebay/blob/master/README.md#Полезные-советы);
...
- Если HDD нет, скорее всего, потребуется докупать HDD mounter (фиксатор диска). Цена вопроса 200-300 рублей на Aliexpress. Подробнее в [Полезных советах](https://github.com/pepe-i-shim/thinkpad-from-ebay/blob/master/README.md#Полезные-советы)
...
4. Проверяете partnumber на ноутбуке с тем, что был указан в лоте на продажу, дабы убедиться что вам прислали тот самый ноутбук.

5. Если все в порядке, включаете и сразу идете в BIOS. Проверяете наличие пароля на него. Так же проверяете статус Computerace.

6. Если все в порядке, начинаете загрузку системы с носителя что был в наличии либо с флешки, проверяете чтобы с матрицей все было в порядке.

7. С помощью USB мыши проверяете все порты и остальные мелочи: работу ethernet порта, wifi, веб-камеру (можно в VLC плеере проверить) и все остальное что вас интересует.
